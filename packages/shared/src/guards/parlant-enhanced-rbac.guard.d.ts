...
import { RBACAuthorizationGuard, AuthenticatedRequest, AuthorizationResult } from "./rbac-authorization.guard";
...
export declare class ParlantEnhancedRBACGuard extends RBACAuthorizationGuard implements CanActivate {
    ...
    constructor(reflector: Reflector, configService: ConfigService, cacheManager: Cache, _parlantService: ParlantIntegrationService);
    canActivate(context: ExecutionContext): Promise<boolean>;
    performConversationalAuthorization(authContext: ConversationalAuthorizationContext, operationId: string): Promise<ConversationalAuthorizationResult>;
    performHighRiskAuthorization(authContext: ConversationalAuthorizationContext, operationId: string): Promise<ConversationalAuthorizationResult>;
