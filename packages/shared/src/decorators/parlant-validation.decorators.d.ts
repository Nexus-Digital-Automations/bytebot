...
export declare function ParlantValidation(
...
export declare function ConversationContext(
...
export declare function SecurityClassification(
  config: SecurityClassificationConfig,
): (
  target: object,
  propertyKey: string,
  descriptor: PropertyDescriptor,
...
export declare function ApprovalWorkflow(
...
export declare function ParlantWrapper(
  config: Partial<ParlantWrapperConfig>,
): (target: new (..._args: unknown[]) => unknown) => void;
export declare function ValidationRules(
  rules: ValidationRule[],
): (
  target: object,
  propertyKey: string,
...
export declare const ConversationParam: (
  ...dataOrPipes: unknown[]
) => ParameterDecorator;
export declare const ValidationRequestParam: (
  ...dataOrPipes: unknown[]
) => ParameterDecorator;
export declare const UserContextParam: (
  ...dataOrPipes: unknown[]
) => ParameterDecorator;
...
export declare function ParlantIntegrated(
  config: CompleteParlantConfig,
): (
  target: object,
  propertyKey: string,
  descriptor: PropertyDescriptor,
) => PropertyDescriptor;
export declare function getParlantValidationMetadata(
  target: object,
  propertyKey: string,
): ParlantValidationConfig | undefined;
export declare function getConversationContextMetadata(
  target: object,
  propertyKey: string,
): ConversationContextConfig | undefined;
export declare function getSecurityClassificationMetadata(
  target: object,
  propertyKey: string,
): SecurityClassificationConfig | undefined;
export declare function getApprovalWorkflowMetadata(
  target: object,
  propertyKey: string,
): ApprovalWorkflowConfig | undefined;
export declare function getValidationRulesMetadata(
  target: object,
  propertyKey: string,
): ValidationRule[] | undefined;
export declare function hasParlantValidation(
  target: object,
  propertyKey: string,
): boolean;
export declare function getAllParlantMetadata(
  target: object,
  propertyKey: string,
): {
...
export declare function ParlantValidated(
  config?: ParlantValidationConfig,
): (
  target: object,
  propertyKey: string,
...
export declare function ParlantSecure(
