...
export declare const RequireAllPermissions: (
  permissions: Permission[],
) => CustomDecorator<string>;
...
export declare const ConditionalAccess: (
  config: ConditionalAccessConfig,
) => CustomDecorator<string>;
export declare const TimeBasedAccess: (
  config: TimeBasedAccessConfig,
) => CustomDecorator<string>;
export declare const IPBasedAccess: (
  config: IPBasedAccessConfig,
) => CustomDecorator<string>;
export declare const AuditAccess: () => CustomDecorator<string>;
export declare const SecureEndpoint: (
...
export declare const ComputerUseAccess: () => (
  target: abstract new (..._args: unknown[]) => unknown,
  propertyKey?: string | symbol,
  descriptor?: PropertyDescriptor,
) => void;
export declare const TaskManagementAccess: () => (
  target: abstract new (..._args: unknown[]) => unknown,
  propertyKey?: string | symbol,
  descriptor?: PropertyDescriptor,
) => void;
export declare const APIAdminAccess: () => (
  target: abstract new (..._args: unknown[]) => unknown,
  propertyKey?: string | symbol,
  descriptor?: PropertyDescriptor,
) => void;
export declare const SecurityManagementAccess: () => (
  target: abstract new (..._args: unknown[]) => unknown,
  propertyKey?: string | symbol,
  descriptor?: PropertyDescriptor,
) => void;
export declare function extractRBACMetadata(
  target: object,
  propertyKey?: string | symbol,
): {
  roles?: Role[];
...
export declare function hasRequiredRoles(
  userRoles: Role[],
  requiredRoles: Role[],
  requireAll?: boolean,
): boolean;
export declare function hasRequiredPermissions(
  userPermissions: Permission[],
  requiredPermissions: Permission[],
  requireAll?: boolean,
): boolean;
export declare function validateTimeBasedAccess(
  config: TimeBasedAccessConfig,
  currentTime?: Date,
): boolean;
export declare function validateIPBasedAccess(
  config: IPBasedAccessConfig,
  clientIP: string,
): boolean;
