...
import { FunctionSecurityLevel, RiskLevel, ParlantConversationContext } from "../types/parlant.types";
...
export declare class ParlantEnhancedAuthMiddleware implements NestMiddleware {
    ...
    constructor(configService: ConfigService, _parlantService: ParlantIntegrationService, _cacheManager: Cache);
    use(req: ParlantAuthenticatedRequest, res: Response, next: NextFunction): Promise<void>;
    performConversationalAuthentication(req: ParlantAuthenticatedRequest, operationId: string): Promise<void>;
    performHighRiskAuthentication(req: ParlantAuthenticatedRequest, operationId: string): Promise<void>;
