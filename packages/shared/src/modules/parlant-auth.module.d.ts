import { DynamicModule, Type, ForwardReference, Provider, InjectionToken, OptionalFactoryDependency } from "@nestjs/common";
...
export interface ParlantAuthModuleAsyncOptions extends Pick<ModuleMetadata, "imports"> {
    ...
    providers?: Provider[];
    useFactory?: (..._args: unknown[]) => Promise<ParlantAuthModuleOptions> | ParlantAuthModuleOptions;
...
export declare function validateParlantAuthConfig(options: ParlantAuthModuleOptions): void;
