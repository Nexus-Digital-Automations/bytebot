import { ParlantConversationContext, RiskLevel } from "../../types/parlant.types";
import { ParlantValidationRequest as ParlantValidationRequestType, ParlantValidationResponse as ParlantValidationResponseType } from "../../types/parlant-integration.types";
...
export declare class ConversationalValidationError extends Error {
    ...
    constructor(conversationId: string | undefined, reasoning: string, suggestedAlternatives?: string[], confidence?: number, riskLevel?: RiskLevel, code?: string, details?: Record<string, unknown>);
    toJSON(): Record<string, unknown>;
    static fromValidationResponse(response: ParlantValidationResponseType, message?: string): ConversationalValidationError;
}
...
export declare class ParlantIntegrationService implements IParlantIntegrationService {
