...
export interface ParlantWebSocketEvents {
    ...
    "parlant:conversation_update": (_conversationId: string, _context: Partial<ParlantConversationContext>) => void;
    "parlant:join_conversation": (_conversationId: string) => void;
    "parlant:leave_conversation": (_conversationId: string) => void;
    "parlant:send_message": (_conversationId: string, _message: ConversationMessage) => void;
