...
exports.SecurityErrorCode = exports.VersioningStrategy = exports.RateLimitPreset = exports.RegisterUserDto = exports.AuthCredentialsDto = exports.Permission = exports.UserRole = exports.DEFAULT_SANITIZATION_OPTIONS = exports.RateLimitServiceType = exports.SecurityEventType = void 0;
...
function createSecurityEvent(_type, _endpoint, _method, _success = false, _message, _metadata, _userId, _ipAddress, _userAgent) {
    const event = {
