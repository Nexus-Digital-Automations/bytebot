...
exports.SecurityErrorCode =
  exports.VersioningStrategy =
  exports.RateLimitPreset =
  exports.RegisterUserDto =
  exports.AuthCredentialsDto =
  exports.Permission =
  exports.UserRole =
  exports.DEFAULT_SANITIZATION_OPTIONS =
  exports.RateLimitServiceType =
...
(function (SecurityEventType) {
  ...
  SecurityEventType["_PERMISSION_ESCALATION_ATTEMPT"] =
    "authz.escalation.attempt";
...
(function (RateLimitServiceType) {
  ...
  RateLimitServiceType ||
    (exports.RateLimitServiceType = RateLimitServiceType = {}),
);
...
(function (SecurityErrorCode) {
  ...
  SecurityErrorCode["_INSUFFICIENT_PERMISSIONS"] =
