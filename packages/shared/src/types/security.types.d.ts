...
export declare function createSecurityEvent(_type: SecurityEventType, _endpoint: string, _method: string, _success?: boolean, _message?: string, _metadata?: Record<string, unknown>, _userId?: string, _ipAddress?: string, _userAgent?: string): SecurityEvent;
