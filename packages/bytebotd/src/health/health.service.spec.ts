...
describe('HealthService', () => {
  ...
  describe('Kubernetes Health Probes', () => {
    ...
    describe('External Services Health', () => {
      ...
      it('should handle external service check errors', async () => {
        ...
        jest
          .spyOn(service as HealthService & { [key: string]: unknown })
           as jest.MockedFunction<any>).mockRejectedValue(new Error('Service error'));
    ...
    describe('Startup Health Check', () => {
      ...
      it('should pass startup check after sufficient uptime', async () => {
        ...
        (service as HealthService & { [key: string]: unknown }).startTime = Date.now() - 15000; // 15 seconds ago
  ...
  describe('Service Stability', () => {
    it('should check service stability with default threshold', () => {
      ...
      (service as HealthService & { [key: string]: unknown }).startTime = Date.now() - 35000;
    ...
    it('should check service stability with custom threshold', () => {
      ...
      (service as HealthService & { [key: string]: unknown }).startTime = Date.now() - 25000;
  ...
  describe('Private Methods', () => {
    describe('Database Ping', () => {
      it('should simulate database ping successfully', async () => {
        const result = await (service as HealthService & { [key: string]: unknown }).performDatabasePing();
    ...
    describe('External Service Check', () => {
      it('should check individual external service', async () => {
        const result = await (service as HealthService & { [key: string]: unknown }).checkExternalService(
          'test-service',
    ...
    describe('Legacy Service Health Check', () => {
      it('should return legacy service health status', () => {
        const services = (service as HealthService & { [key: string]: unknown }).checkServiceHealth();
