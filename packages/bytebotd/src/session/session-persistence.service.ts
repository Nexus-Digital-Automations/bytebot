...
export class SessionPersistenceService implements OnModuleInit, OnApplicationShutdown {
  ...
  private async calculateChecksum(data: any): Promise<string> { return 'checksum'; }
  private async selectStorageNodes(session: SessionMetadata): Promise<StorageNodeConfig[]> { return []; }
  private async replicateData(data: any, nodes: StorageNodeConfig[]): Promise<any> { return {}; }
