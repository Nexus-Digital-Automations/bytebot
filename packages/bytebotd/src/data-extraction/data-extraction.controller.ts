...
export class DataExtractionController {
  ...
  @ApiOperation({
    ...
    description: 'Extract various types of data from web pages including tables, lists, text, links, images, and custom patterns. Supports multiple output formats and advanced configuration.',
  ...
  @ApiOperation({
    ...
    description: 'Perform multiple data extraction operations on a single page or across multiple pages. Supports parallel execution and result aggregation.',
  ...
  async extractMultiple(
    ...
    this.logger.log(
      `[${operationId}] Multi-extraction request`,
      {
        operationId,
  ...
  @ApiOperation({
    ...
    description: 'Extract table data with advanced configuration options including header detection, column filtering, and row limiting.',
  ...
  async extractTables(
    ...
    @Body('outputFormat') outputFormat: ExtractionOutputFormat = ExtractionOutputFormat.JSON,
    @CurrentUser() user: ByteBotdUser,
  ): Promise<DataExtractionResponseDto> {
  ...
  @ApiOperation({
    ...
    description: 'Extract text content with pattern matching, formatting preservation, and length filtering options.',
  ...
  @ApiOperation({
    ...
    description: 'Extract links with filtering options for internal/external links, attribute extraction, and URL pattern matching.',
  ...
  @ApiOperation({
    ...
    description: 'Extract image data with dimension filtering, attribute extraction, and optional base64 data inclusion.',
  ...
  async extractImages(
    ...
    const params: DataExtractionDto = {
      ...
      imageConfig: {
        ...
        minDimensions: minWidth && minHeight ? { width: minWidth, height: minHeight } : undefined
      },
      config: {
        includeMetadata: true
      }
  ...
  @ApiOperation({
    ...
    description: 'Extract data using custom CSS selectors with configurable attribute and content extraction options.',
  ...
  @ApiOperation({
    ...
    description: 'Returns supported data extraction types and output formats for building dynamic extraction interfaces.',
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        outputFormats: {
          type: 'array',
          items: { type: 'string', enum: Object.values(ExtractionOutputFormat) }
        }
      }
    }
  })
