...
import { Type } from 'class-transformer'; /*** Data extraction types supported by the system
 */
...
export class TableExtractionConfigDto {
  ...
  @ApiPropertyOptional({
    description: 'Column indices to extract (0-based)',
    example: [0, 2, 4],
  })
  @IsOptional()
  @IsArray()
...
export class ListExtractionConfigDto {
  @ApiPropertyOptional({
    description: 'Extract nested lists',
    example: true,
    default: false,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Maximum depth for nested lists',
    example: 3,
    default: 1,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Extract list item attributes',
    example: true,
    default: false,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Filter list items by pattern',
    example: '^Product:',
  })
  @IsOptional()
  @IsString()
...
export class TextExtractionConfigDto {
  ...
  @ApiPropertyOptional({
    description: 'Extract only visible text',
    example: true,
    default: true,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Minimum text length to extract',
    example: 10,
    default: 1,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Text patterns to extract (regex)',
...
export class LinkExtractionConfigDto {
  @ApiPropertyOptional({
    description: 'Include internal links only',
    example: false,
    default: false,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Include external links only',
    example: false,
    default: false,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Extract link attributes',
    example: ['title', 'target', 'rel'],
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
...
export class ImageExtractionConfigDto {
  @ApiPropertyOptional({
    description: 'Include image data (base64)',
    example: false,
    default: false,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Include image attributes',
    example: ['alt', 'title', 'width', 'height'],
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
...
export class CustomPatternConfigDto {
  ...
  @ApiPropertyOptional({
    ...
    example: ['data-id', 'data-price', 'data-name'],
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({
    description: 'Extract element text content',
    example: true,
    default: true,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Extract element HTML content',
    example: false,
    default: false,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Extract child elements',
    example: true,
    default: false,
  })
  @IsOptional()
...
export class DataExtractionConfigDto {
  @ApiPropertyOptional({
    description: 'Timeout for extraction operations in milliseconds',
    example: 30000,
    default: 30000,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Whether to take screenshots during extraction',
    example: true,
    default: false,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Wait for dynamic content loading',
    example: true,
    default: false,
  })
  @IsOptional()
...
export class DataExtractionDto {
  ...
  @ApiPropertyOptional({
    ...
    example: '#dataTable, .product-list, .article-content',
  })
  @IsOptional()
  @IsString()
  selector?: string;
  ...
  @ApiPropertyOptional({
    description: 'Page URL to extract data from',
  ...
  @ApiPropertyOptional({
    description: 'General extraction configuration',
  ...
  @ApiPropertyOptional({
    description: 'Table-specific extraction configuration',
  ...
  @ApiPropertyOptional({
    description: 'List-specific extraction configuration',
  ...
  @ApiPropertyOptional({
    description: 'Text-specific extraction configuration',
  ...
  @ApiPropertyOptional({
    description: 'Link-specific extraction configuration',
  ...
  @ApiPropertyOptional({
    description: 'Image-specific extraction configuration',
  ...
  @ApiPropertyOptional({
    description: 'Custom pattern extraction configuration',
  ...
  @ApiPropertyOptional({
    ...
    example: { sessionId: 'abc123', extractionId: 'extract456' },
  })
  @IsOptional()
  @IsObject()
...
export class MultiSelectorExtractionDto {
  @ApiProperty({
    description: 'Multiple extraction operations to perform',
  ...
  @ApiPropertyOptional({
    description: 'Page URL to extract data from (applies to all extractions)',
    example: 'https://example.com/data',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'Global extraction configuration',
    type: DataExtractionConfigDto,
  })
  @IsOptional()
  @ValidateNested()
  ...
  @ApiPropertyOptional({
    description: 'Whether to execute extractions in parallel',
    example: true,
    default: false,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Additional metadata for the operation',
    example: { sessionId: 'abc123', batchId: 'batch456' },
  })
  @IsOptional()
  @IsObject()
  metadata?: Record<string, any>;
