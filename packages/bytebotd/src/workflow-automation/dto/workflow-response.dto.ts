...
} from './workflow.dto'; /*** Step execution status
 */
...
export class StepExecutionResultDto {
  ...
  @ApiPropertyOptional({
    ...
    example: { success: true, formFieldsFilled: 2, validationPassed: true },
  })
  result?: {
    success: boolean;
  ...
  @ApiPropertyOptional({
    ...
    example: { memoryUsage: '45.2MB', cpuUsage: '15%', networkRequests: 3 },
  })
...
export class WorkflowExecutionResponseDto {
  ...
  @ApiPropertyOptional({
    ...
    example: [
      'Step timeout increased automatically',
      'Rate limiting detected on target site',
    ],
  })
  warnings?: string[];
