...
export class EventFilterDto {
  ...
  @ApiPropertyOptional({
    description: 'Filter events by source URL pattern',
  })
  @IsOptional()
  @IsString()
  urlPattern?: string;
  ...
  @ApiPropertyOptional({
    description: 'Filter events by element selector',
  })
  @IsOptional()
  @IsString()
...
export class RealtimeSubscriptionDto {
  ...
  @ApiPropertyOptional({
    description: 'Include event payload data',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Include screenshots with events',
    default: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Event buffer size for missed events',
    minimum: 0,
    maximum: 1000,
    default: 100,
  })
  ...
  @ApiPropertyOptional({
    description: 'Client identifier for debugging',
    example: 'automation_client_001',
  })
  @IsOptional()
  @IsString()
  clientId?: string;
...
export class RealtimeEventDto {
  ...
  @ApiPropertyOptional({
    description: 'Element selector if event is element-related',
  })
  elementSelector?: string;

  @ApiPropertyOptional({
    description: 'Element information if available',
    type: 'object',
    properties: {
      tagName: { type: 'string' },
      id: { type: 'string' },
  ...
  @ApiPropertyOptional({
    description: 'Screenshot data (base64) if enabled',
  })
  screenshot?: string;

  @ApiPropertyOptional({
    description: 'Network request/response data for network events',
    type: 'object',
    properties: {
      method: { type: 'string' },
      url: { type: 'string' },
  ...
  @ApiPropertyOptional({
    description: 'Performance metrics for performance events',
    type: 'object',
    properties: {
  ...
  @ApiPropertyOptional({
    description: 'Task execution data for task events',
    type: 'object',
    properties: {
      taskId: { type: 'string' },
...
export class RealtimeConnectionStatusDto {
  ...
  @ApiProperty({
    description: 'Connection established timestamp',
  })
  ...
  @ApiProperty({
    description: 'Active subscription types',
    type: [String],
    enum: SubscriptionType,
  })
  ...
  @ApiProperty({
    description: 'Events in buffer',
  })
  eventsBuffered: number = 0;
  ...
  @ApiPropertyOptional({
    description: 'Connection error if any',
  })
  error?: string;
...
export class SSEConfigDto {
  ...
  @ApiPropertyOptional({
    description: 'Event stream identifier',
    example: 'stream_automation_001',
  })
  @IsOptional()
  @IsString()
  streamId?: string;
  ...
  @ApiPropertyOptional({
    description: 'Keep connection alive with heartbeats',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Include retry information in events',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
...
export class RealtimeEventStatsDto {
  ...
  @ApiProperty({
    description: 'Statistics collection period start',
  })
  periodStart: Date = new Date();

  @ApiProperty({
    description: 'Statistics collection period end',
  })
  ...
  @ApiProperty({
    description: 'Average events per minute',
  })
  averageEventsPerMinute: number = 0;

  @ApiProperty({
    description: 'Peak events per minute',
  })
  peakEventsPerMinute: number = 0;
  ...
  @ApiPropertyOptional({
    ...
    properties: {
      ...
      connectionDrops: { type: 'number' },
      reconnectionAttempts: { type: 'number' },
      successfulReconnections: { type: 'number' },
    },
  })
  connectionMetrics?: {
  ...
  @ApiPropertyOptional({
    description: 'Additional statistics metadata',
    type: 'object',
    additionalProperties: true,
  })
  metadata?: Record<string, unknown>;
