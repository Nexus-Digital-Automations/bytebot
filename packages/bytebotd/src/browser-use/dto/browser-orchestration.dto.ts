...
export class MultiAgentConfigDto {
  ...
  @ApiPropertyOptional({
    description: 'Enable session reuse across tasks',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Task distribution load balancing strategy',
    enum: LoadBalancingStrategy,
    default: LoadBalancingStrategy.ADAPTIVE,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Agent coordination timeout in milliseconds',
    minimum: 5000,
    maximum: 300000,
    default: 60000,
  })
  ...
  @ApiPropertyOptional({
    description: 'Enable intelligent task batching',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Maximum batch size for task grouping',
    minimum: 1,
    maximum: 10,
    default: 3,
  })
...
export class PerformanceConfigDto {
  @ApiPropertyOptional({
    description: 'Enable task result caching',
    default: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Memory usage threshold for scaling (percentage)',
    minimum: 50,
    maximum: 95,
    default: 80,
  })
  ...
  @ApiPropertyOptional({
    description: 'CPU usage threshold for scaling (percentage)',
    minimum: 50,
    maximum: 95,
    default: 85,
  })
...
export class BrowserOrchestrationDto {
  @ApiProperty({
    description: 'List of browser tasks to orchestrate',
  ...
  @ApiPropertyOptional({
    description: 'Orchestration execution strategy',
  ...
  @ApiPropertyOptional({
    description: 'Global orchestration timeout in milliseconds',
    minimum: 10000,
    maximum: 1800000,
    default: 600000,
  })
  ...
  @ApiPropertyOptional({
    description: 'Enable real-time progress monitoring via WebSocket',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    ...
    default: FailureStrategy.RETRY_FAILED,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Custom orchestration metadata',
    type: 'object',
...
export class OrchestrationAgentMetricsDto {
  ...
  @ApiPropertyOptional({
    description: 'Load balancing efficiency metrics',
    type: 'object',
    additionalProperties: true,
  })
...
export class OrchestrationErrorDto {
  ...
  @ApiPropertyOptional({
    description: 'Error recovery suggestions',
    type: [String],
  })
...
export class BrowserOrchestrationResultDto {
  ...
  @ApiProperty({
    description: 'Individual task execution results',
    type: [BrowserTaskResultDto],
  })
  taskResults: BrowserTaskResultDto[] = [];

  @ApiPropertyOptional({
    description: 'Agent utilization and performance metrics',
    type: OrchestrationAgentMetricsDto,
  })
  agentMetrics?: OrchestrationAgentMetricsDto;

  @ApiProperty({
    description: 'Orchestration execution logs',
    type: [OrchestrationLogEntryDto],
  })
  logs: OrchestrationLogEntryDto[] = [];

  @ApiPropertyOptional({
    description: 'Error information if orchestration failed',
    type: OrchestrationErrorDto,
  })
...
export class OrchestrationProgressUpdateDto {
  ...
  @ApiPropertyOptional({
    description: 'Current agent status information',
    type: [Object],
  })
  agentStatus?: Array<{
    agentId: string;
...
export class OrchestrationMetricsSummaryDto {
  @ApiProperty({
    ...
    properties: {
      ...
      totalTasksExecuted: { type: 'number' },
      overallSuccessRate: { type: 'number' },
      averageOrchestrationTime: { type: 'number' },
    },
  })
  summary: {
  ...
  @ApiProperty({
    ...
    type: 'object',
    properties: {
      orchestrationsLast24h: { type: 'number' },
      tasksLast24h: { type: 'number' },
      successRateLast24h: { type: 'number' },
    },
  })
  recentPerformance: {
