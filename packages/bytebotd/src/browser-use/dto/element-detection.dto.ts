...
export class ElementAttributeFilterDto {
  ...
  @ApiPropertyOptional({
    description: 'Use regex matching for value',
    default: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Attribute must be present (ignore value)',
    default: false,
  })
  @IsOptional()
  @IsBoolean()
...
export class TextContentFilterDto {
  ...
  @ApiPropertyOptional({
    description: 'Include child element text in search',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
...
export class VisualSimilarityFilterDto {
  ...
  @ApiPropertyOptional({
    description: 'Comparison region (relative to element)',
    type: 'object',
    properties: {
...
export class AIDescriptionFilterDto {
  @ApiProperty({
    ...
    example: 'The blue submit button in the footer',
  })
  @IsString()
  description: string = '';
...
export class ElementDetectionCriteriaDto {
  ...
  @ApiPropertyOptional({
    description: 'Text content filter for TEXT_CONTENT strategy',
  ...
  @ApiPropertyOptional({
    description: 'Attribute filters for ATTRIBUTE_VALUE strategy',
  ...
  @ApiPropertyOptional({
    description: 'Visual similarity filter for VISUAL_SIMILARITY strategy',
  ...
  @ApiPropertyOptional({
    description: 'AI description filter for AI_DESCRIPTION strategy',
  ...
  @ApiPropertyOptional({
    description: 'Element tag name filter',
    example: 'button',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'Required visibility state',
  ...
  @ApiPropertyOptional({
    description: 'Required interactability state',
    enum: ElementInteractability,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Element index when multiple matches (0-based)',
    minimum: 0,
  })
  @IsOptional()
  @IsNumber()
...
export class ElementWaitConfigDto {
  ...
  @ApiPropertyOptional({
    description: 'Stability check duration (element must remain stable)',
    minimum: 0,
    maximum: 10000,
    default: 0,
  })
  ...
  @ApiPropertyOptional({
    description: 'Abort wait if condition is not met initially',
    default: false,
  })
  @IsOptional()
  @IsBoolean()
...
export class ElementDetectionDto {
  ...
  @ApiProperty({
    description: 'Element detection criteria',
  ...
  @ApiPropertyOptional({
    description: 'Wait configuration for element detection',
  ...
  @ApiPropertyOptional({
    description: 'Include element screenshot in result',
    default: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Include element HTML content in result',
    default: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Include computed styles in result',
    default: false,
  })
  @IsOptional()
  @IsBoolean()
...
export class BatchElementDetectionDto {
  ...
  @ApiProperty({
    description: 'Array of element detection requests',
    type: [ElementDetectionDto],
  })
  @IsArray()
  @ValidateNested({ each: true })
  @Type(() => ElementDetectionDto)
  detections: Omit<ElementDetectionDto, 'sessionId'>[] = [];

  @ApiPropertyOptional({
    description: 'Continue detection on individual failures',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Maximum concurrent detections',
    minimum: 1,
    maximum: 10,
    default: 3,
  })
...
export class DetectedElementDto {
  ...
  @ApiProperty({
    description: 'Element interactability state',
    enum: ElementInteractability,
  })
  ...
  @ApiProperty({
    description: 'XPath that uniquely identifies this element',
  })
  uniqueXPath: string = '';
  ...
  @ApiPropertyOptional({
    description: 'Parent element information',
    type: 'object',
    properties: {
      tagName: { type: 'string' },
      id: { type: 'string' },
  ...
  @ApiPropertyOptional({
    description: 'Child elements count',
  })
  childCount?: number;
...
export class ElementDetectionResultDto {
  ...
  @ApiProperty({
    description: 'Detection strategy used',
    enum: DetectionStrategy,
  })
  strategy: DetectionStrategy = DetectionStrategy.CSS_SELECTOR;
  ...
  @ApiPropertyOptional({
    description: 'Primary detected element (first match)',
    type: DetectedElementDto,
  })
  ...
  @ApiPropertyOptional({
    ...
    type: 'object',
    properties: {
      condition: { type: 'string', enum: Object.values(WaitCondition) },
  ...
  @ApiProperty({
    description: 'Page URL at time of detection',
  })
  pageUrl: string = '';

  @ApiProperty({
    description: 'Page title at time of detection',
  })
  pageTitle: string = '';
...
export class BatchElementDetectionResultDto {
  ...
  @ApiProperty({
    description: 'Array of individual detection results',
    type: [ElementDetectionResultDto],
  })
  detections: ElementDetectionResultDto[] = [];

  @ApiProperty({
    description: 'Total detections requested',
  })
  totalRequested: number = 0;

  @ApiProperty({
    description: 'Detections completed successfully',
  })
  successfulDetections: number = 0;

  @ApiProperty({
    description: 'Detections that failed',
  })
  failedDetections: number = 0;

  @ApiProperty({
    description: 'Total elements found across all detections',
  })
  totalElementsFound: number = 0;
