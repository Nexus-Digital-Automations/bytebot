...
import { FileOperationType, FileFormat, FileUploadMethod, FileDownloadMethod } from './file-operation.dto';
...
export class FileInfoDto {
  ...
  @ApiPropertyOptional({
    ...
    example: { pages: 15, author: 'John Doe', title: 'Sample Document' }
  })
...
export class FileValidationResultDto {
  ...
  @ApiPropertyOptional({
    ...
    example: ['File size exceeds maximum limit', 'File type not allowed']
  })
  errors?: string[];

  @ApiPropertyOptional({
    description: 'Validation warnings',
    example: ['File may contain macros', 'Large file size detected']
  })
  warnings?: string[];

  @ApiPropertyOptional({
    description: 'Virus scan result',
    example: { clean: true, engine: 'ClamAV', signature: 'v2024.01.15' }
  })
  virusScanResult?: any;

  @ApiPropertyOptional({
    description: 'Content validation result',
    example: { validFormat: true, corruptionDetected: false }
  })
...
export class FileUploadResultDto {
  @ApiProperty({
    description: 'Upload operation ID',
    example: 'upload_1704454800_abc123'
  })
  operationId: string;
  ...
  @ApiProperty({
    ...
    example: FileOperationStatus.COMPLETED
  })
  ...
  @ApiPropertyOptional({
    description: 'Server response after upload',
    example: { success: true, fileId: 'file_12345', message: 'Upload successful' }
  })
  serverResponse?: any;

  @ApiPropertyOptional({
    description: 'Upload error message if failed',
    example: 'Network timeout during upload'
  })
  errorMessage?: string;

  @ApiPropertyOptional({
    description: 'Screenshot of upload interface',
  ...
  @ApiPropertyOptional({
    ...
    example: { targetForm: '#uploadForm', submitButton: '#submitBtn' }
  })
  metadata?: Record<string, any>;
}
...
export class FileDownloadResultDto {
  @ApiProperty({
    description: 'Download operation ID',
    example: 'download_1704454800_xyz789'
  })
  operationId: string;
  ...
  @ApiProperty({
    description: 'Download method used',
  ...
  @ApiPropertyOptional({
    ...
    example: '2024-01-15T10:31:20.000Z'
  })
  endTime?: string;
  ...
  @ApiPropertyOptional({
    description: 'Source URL of downloaded file',
    example: 'https://example.com/files/document.pdf'
  })
  sourceUrl?: string;

  @ApiPropertyOptional({
    description: 'Local file path where file was saved',
    example: '/downloads/automation/document.pdf'
  })
  localPath?: string;

  @ApiPropertyOptional({
    description: 'Download verification result',
    example: { verified: true, checksumMatch: true, sizeMatch: true }
  })
  verification?: any;

  @ApiPropertyOptional({
    description: 'Download error message if failed',
    example: 'File not found at specified URL'
  })
  errorMessage?: string;

  @ApiPropertyOptional({
    description: 'Screenshot of download interface',
    example: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg=='
  })
  screenshot?: string;
  ...
  @ApiPropertyOptional({
    ...
    example: { 'content-type': 'application/pdf', 'content-length': '2048576' }
  })
...
export class FileOperationResponseDto {
  ...
  @ApiProperty({
    ...
    example: 'op_1704454800_abc123'
  })
  operationId: string;

  @ApiPropertyOptional({
    description: 'Upload result (if operation was upload)',
    type: FileUploadResultDto
  })
  uploadResult?: FileUploadResultDto;

  @ApiPropertyOptional({
    description: 'Download result (if operation was download)',
    type: FileDownloadResultDto
  })
  downloadResult?: FileDownloadResultDto;

  @ApiPropertyOptional({
    description: 'File information (for various operations)',
    type: FileInfoDto
  })
  fileInfo?: FileInfoDto;
  ...
  @ApiPropertyOptional({
    description: 'Operation error message if failed',
    example: 'Failed to access target directory'
  })
  errorMessage?: string;

  @ApiPropertyOptional({
    description: 'Detailed error information',
    example: { errorCode: 'PERMISSION_DENIED', details: 'Insufficient permissions' }
  })
  errorDetails?: any;

  @ApiPropertyOptional({
    description: 'Operation warnings',
    example: ['File already exists, overwriting', 'Large file may take longer to process']
  })
  warnings?: string[];

  @ApiPropertyOptional({
    description: 'Additional operation metadata',
    example: { sourceElement: '#fileUpload', targetDirectory: '/uploads' }
  })
  metadata?: Record<string, any>;
}
...
export class BulkFileOperationResponseDto {
  ...
  @ApiProperty({
    ...
    example: 'bulk_1704454800_xyz789'
  })
  operationId: string;
  ...
  @ApiPropertyOptional({
    description: 'Bulk operation completion time',
  ...
  @ApiPropertyOptional({
    ...
    example: 'Bulk operation timeout exceeded'
  })
  errorMessage?: string;
}
...
export class FileListingResponseDto {
  ...
  @ApiPropertyOptional({
    description: 'Listing filters applied',
    example: { extensions: ['.pdf', '.doc'], minSize: 1024 }
  })
...
export class FileSyncResponseDto {
  @ApiProperty({
    description: 'Synchronization success status',
    example: true
  })
  success: boolean;
  ...
  @ApiProperty({
    ...
    example: 'sync_1704454800_xyz789'
  })
  operationId: string;
  ...
  @ApiProperty({
    description: 'Files that were synchronized',
    type: [FileInfoDto]
  })
  ...
  @ApiProperty({
    description: 'Total bytes synchronized',
    example: 52428800
  })
  ...
  @ApiPropertyOptional({
    ...
    example: [{ file: 'locked.txt', error: 'File is locked by another process' }]
  })
  errors?: any[];

  @ApiPropertyOptional({
    description: 'Conflict resolution actions taken',
    example: [{ file: 'duplicate.txt', action: 'renamed to duplicate_1.txt' }]
  })
