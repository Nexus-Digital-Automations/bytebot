...
export declare class ConversationalValidationError extends Error {
    ...
    readonly reasoning: string;
    readonly suggestedAlternatives: string[];
    constructor(conversationId: string, reasoning: string, suggestedAlternatives?: string[]);
}
/**
...
export declare class ParlantIntegrationService implements OnApplicationShutdown {
