...
import { InputTrackingService } from './input-tracking.service'; /*** Input Tracking Controller - Secured Input Monitoring API
 *
...
export class InputTrackingController {
  ...
  @ApiOperation({
    ...
    description:
      'Begin monitoring system input events. Requires OPERATOR or ADMIN role.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Stop monitoring system input events. Requires OPERATOR or ADMIN role.',
  })
  @ApiResponse({
    status: 200,
