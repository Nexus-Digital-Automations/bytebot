...
export class ResultStorageInfoDto {
  @ApiProperty({
    ...
    example: 'result_1702983456789_xyz890',
  })
  @IsString()
  @IsUUID('4')
  resultId: string = '';
  ...
  @ApiProperty({
    description: 'Original result size in bytes',
    example: 2048576,
  })
  @IsNumber()
  @Min(0)
  ...
  @IsEnum(['json', 'binary', 'text', 'stream'])
  format: string = 'json';
  ...
  @ApiPropertyOptional({
    description: 'Number of chunks for streaming results',
    example: 25,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiProperty({
    ...
    example: 'bytebot:job:result:job_1702983456789_abc123',
  })
  @IsString()
  ...
  @ApiProperty({
    ...
    example: '2023-12-26T10:31:15.789Z',
  })
  @IsDateString()
  expiresAt: string = '';
...
export class ResultChunkInfoDto {
  ...
  @ApiProperty({
    ...
    example: 'b2c3d4e5f6789012345678901234567890abcdef1',
  })
  @IsString()
  checksum: string = '';

  @ApiPropertyOptional({
    description: 'Download URL for this specific chunk',
    example: 'https://api.bytebot.com/jobs/job_123/result/chunks/5',
  })
  @IsOptional()
  @IsUrl()
  downloadUrl?: string;
...
export class ResultDownloadRequestDto {
  ...
  @IsOptional()
  @IsEnum(['json', 'binary', 'text', 'original'])
  format?: string = 'original';

  @ApiPropertyOptional({
    description: 'Whether to enable compression for download',
    example: true,
    default: true,
  })
  @IsOptional()
...
export class ResultDownloadResponseDto {
  ...
  @ApiProperty({
    description: 'Download URL for the result',
    example: 'https://api.bytebot.com/jobs/job_123/result/download?token=abc123',
  })
  @IsUrl()
  downloadUrl: string = '';

  @ApiProperty({
    description: 'Result storage information',
    type: ResultStorageInfoDto,
  })
  @ValidateNested()
  @Type(() => ResultStorageInfoDto)
  ...
  @ApiProperty({
    ...
    example: '2023-12-19T11:31:15.789Z',
  })
  @IsDateString()
  expiresAt: string = '';

  @ApiPropertyOptional({
    description: 'Chunk information for streaming downloads',
...
export class ResultExportRequestDto {
  ...
  @IsEnum(['json', 'csv', 'xml', 'excel', 'pdf', 'text'])
  targetFormat: string = '';
  ...
  @ApiPropertyOptional({
    ...
    example: 'job-results-2023-12-19.csv',
  })
  @IsOptional()
  @IsString()
  filename?: string;
...
export class ResultExportResponseDto {
  ...
  @ApiProperty({
    ...
    example: 'https://api.bytebot.com/exports/export_456/download',
  })
  @IsUrl()
  downloadUrl: string = '';
  ...
  @ApiProperty({
    ...
    example: '2023-12-19T12:31:15.789Z',
  })
  @IsDateString()
  expiresAt: string = '';

  @ApiPropertyOptional({
    description: 'Export processing metrics',
    type: Object,
  })
  @IsOptional()
  @IsObject()
...
export class BulkResultRequestDto {
  ...
  @IsOptional()
  @IsEnum(['json', 'summary'])
  resultFormat?: string = 'summary';

  @ApiPropertyOptional({
    description: 'Maximum total response size in MB',
    example: 50,
    default: 50,
  })
  @IsOptional()
...
export class BulkResultResponseDto {
  ...
  @ApiProperty({
    description: 'Total jobs requested',
    example: 5,
  })
  @IsNumber()
  @Min(0)
