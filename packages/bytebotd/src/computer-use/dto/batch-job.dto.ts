...
export enum DependencyType {
  SEQUENTIAL = 'sequential', // Job must wait for dependency to complete
  CONDITIONAL = 'conditional', // Job runs only if dependency succeeds
  PARALLEL = 'parallel', // Job can run in parallel but starts after dependency
}
...
export enum BatchExecutionMode {
  ...
  PARALLEL = 'parallel', // Execute all jobs simultaneously
  MIXED = 'mixed', // Use job-specific dependencies and priorities
}
...
export class BatchJobSpecDto {
  ...
  @ApiPropertyOptional({
    ...
    example: { stepName: 'capture-screen', retryable: true },
  })
  @IsOptional()
...
export class BatchJobSubmissionDto {
  ...
  @ApiPropertyOptional({
    ...
    example: { workflowName: 'ui-automation', userId: 'user123' },
  })
  @IsOptional()
  metadata?: Record<string, unknown>;
}
...
export class BatchJobSubmissionResponseDto {
  ...
  @ApiProperty({
    description: 'Individual job IDs within the batch',
    example: {
      'screenshot-job-1': 'job_1702983456789_abc123',
      'click-job-2': 'job_1702983456790_def456',
    },
  })
  ...
  @ApiPropertyOptional({
    ...
    example: '2023-12-19T10:35:45.789Z',
  })
  @IsOptional()
  @IsDateString()
...
export class JobSearchCriteriaDto {
  ...
  @ApiPropertyOptional({
    ...
    example: '2023-12-19T00:00:00.000Z',
  })
  @IsOptional()
  @IsDateString()
  ...
  @ApiPropertyOptional({
    ...
    example: '2023-12-19T23:59:59.999Z',
  })
  @IsOptional()
  @IsDateString()
  ...
  @ApiPropertyOptional({
    ...
    example: 'submittedAt',
    enum: ['submittedAt', 'completedAt', 'executionTime', 'priority', 'status'],
  })
  @IsOptional()
  @IsString()
...
export class JobAnalyticsDto {
  ...
  @ApiProperty({
    ...
    example: [
      { hour: '2023-12-19T10:00:00Z', jobCount: 45, avgExecutionTime: 2300 },
      { hour: '2023-12-19T11:00:00Z', jobCount: 52, avgExecutionTime: 2150 },
    ],
  })
...
export class JobProgressUpdateDto {
  ...
  @ApiPropertyOptional({
    ...
    example: 'Processing image recognition...',
  })
  @IsOptional()
  @IsString()
  currentStep?: string;
