...
export const errorRecoveryConfig = () => ({
  errorRecovery: {
    ...
    halfOpenMaxCalls: parseInt(process.env.ERROR_RECOVERY_HALF_OPEN_MAX_CALLS || '3'),

    // Feature flags
    enableCircuitBreaker: process.env.ERROR_RECOVERY_ENABLE_CIRCUIT_BREAKER !== 'false',
    ...
    enableAutoRecovery: process.env.ERROR_RECOVERY_ENABLE_AUTO_RECOVERY !== 'false',

    // Monitoring and alerting
    enableMetrics: process.env.ERROR_RECOVERY_ENABLE_METRICS !== 'false',
