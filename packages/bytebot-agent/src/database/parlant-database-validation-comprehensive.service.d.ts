...
export declare class ParlantDatabaseValidationComprehensiveService {
  ...
  private readonly logger;
  constructor(
    queryRiskAgent: QueryRiskAssessmentAgent,
    transactionAgent: TransactionManagementAgent,
    auditAgent: DataAuditTrailAgent,
    explanationAgent: NaturalLanguageExplanationAgent,
    integrityAgent: DataIntegrityValidationAgent,
    securityAgent: DatabaseSecurityValidationAgent,
  );
